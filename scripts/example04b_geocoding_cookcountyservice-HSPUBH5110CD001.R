...
# batch geocoding using Cook County API
# works (encoded)
# https://gisinternal.cookcountyil.gov/secure/rest/services/AddressLocator/CookAddressComposite/GeocodeServer/geocodeAddresses?addresses=%7B%22records%22%3A%5B%7B%22attributes%22%3A%7B%22OBJECTID%22%3A1%2C%22STREET%22%3A%22636+Fair+Oaks%22%2C%22ZONE%22%3A%2260302%22%7D%7D%2C%7B%22attributes%22%3A%7B%22OBJECTID%22%3A2%2C%22STREET%22%3A%22116+S+East+Ave%22%2C%22ZONE%22%3A%2260302%22%7D%7D%5D%7D&category=&sourceCountry=&matchOutOfRange=true&langCode=&locationType=&searchExtent=&outSR=&f=pjson

# address list json (decoded)
# {"records":[{"attributes":{"OBJECTID":1,"STREET":"636 Fair Oaks","ZONE":"60302"}},{"attributes":{"OBJECTID":2,"STREET":"116 S East Ave","ZONE":"60302"}}]}
...
#   group_by(CASENO) %>%
#   nest(attributes = c(OBJECTID,STREET,ZONE))
